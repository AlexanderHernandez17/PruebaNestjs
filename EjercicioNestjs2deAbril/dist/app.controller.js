...
let AppController = class AppController {
    ...
    getOnlyOneParamById(id) {
        return `This return a only param ${id}`;
    }
    createStudentByName(body) {
        return body;
    }
    updateStudents(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AppController.prototype, "getNotes", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], AppController.prototype, "getOnlyOneParamById", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", void 0)
], AppController.prototype, "createStudentByName", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AppController.prototype, "updateStudents", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('/convert/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], AppController.prototype, "convertNUmber", null);
